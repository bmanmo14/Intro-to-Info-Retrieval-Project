...
public class FeedbackData {
    ...
    public FeedbackData(Retrieval r, Set<String> exclusionTerms, List<ScoredDocument> results, Parameters fbParams) throws IOException{
        ...
        docLength = new HashMap <ScoredDocument, Integer> ();
        termCounts = new HashMap <String, Map<ScoredDocument, Integer>> ();
        termCountsReverse = new HashMap<ScoredDocument, Map<String, Integer>>();
        process();
    }
